...
const InfoCard: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-2 sm:p-4 md:p-6 text-white bg-gray-800 rounded-2xl">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center mb-2 sm:mb-4">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl lg:3xl text-gradient font-bold text-center sm:text-left">
          ThermoSense
        </h2>
      </div>

      {/* Description */}
      <p className="text-gray-300 text-xs sm:text-xs md:text-sm lg:text-sm mb-4 text-justify">
